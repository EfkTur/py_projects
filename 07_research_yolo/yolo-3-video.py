...
video = cv2.VideoCapture('videos/Travel to Sevilla - Spain - 4K-9-PCsRiv6Us.mp4')
...
with open('yolo-coco-data/custom.names') as f:
...
network = cv2.dnn.readNetFromDarknet('yolo-coco-data/yolov3_custom_test.cfg',
                                     'yolo-coco-data/yolov3_custom_train_final.weights')
...
while True:
    ...
    if writer is None:
        ...
        writer = cv2.VideoWriter('videos/sevilla.mp4', fourcc, 30,
