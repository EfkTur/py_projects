...
full_path_to_images = '/content/drive_yolo_files/mask_dataset'
...
# We have decided to make the choice of the test set at random
# to write into the test.txt file
p_test = random.sample(p,int(test_share * n))

# Deleting from initial list the elements 
